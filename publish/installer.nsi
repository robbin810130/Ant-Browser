...
!if /FileExists "${STAGINGDIR}\publish\*"
  ...
  SetOutPath "$INSTDIR"
!endif
!if /FileExists "${STAGINGDIR}\apps\*"
  SetOutPath "$INSTDIR\apps"
  File /r "${STAGINGDIR}\apps\*"
  SetOutPath "$INSTDIR"
!endif
!if /FileExists "${STAGINGDIR}\runtime\*"
  SetOutPath "$INSTDIR\runtime"
  File /r "${STAGINGDIR}\runtime\*"
  SetOutPath "$INSTDIR"
!endif
!if /FileExists "${STAGINGDIR}\installer\*"
  SetOutPath "$INSTDIR\installer"
  File /r "${STAGINGDIR}\installer\*"
  SetOutPath "$INSTDIR"
!endif
