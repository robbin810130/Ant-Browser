...
export function ApplyDesktopReleaseUpdate() {
...
export function CheckDesktopReleaseUpdate() {
...
export function ExportDesktopEnvironmentDiagnostics() {
  return window['go']['main']['App']['ExportDesktopEnvironmentDiagnostics']();
}
...
export function RepairDesktopEnvironment() {
  return window['go']['main']['App']['RepairDesktopEnvironment']();
}
